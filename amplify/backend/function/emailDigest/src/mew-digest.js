                                ...
                                react_1["default"].createElement(components_1.Container, { style: { display: 'flex', alignItems: 'center', width: '100%' } },
                                    react_1["default"].createElement(components_1.Row, { style: { gap: '10px', alignItems: 'center', width: '100%' } },
                                        ...
                                        react_1["default"].createElement(components_1.Column, { style: { flex: '1', padding: '0 10px' } },
                                            ...
                                            react_1["default"].createElement(components_1.Link, { style: link, href: ((_f = comment === null || comment === void 0 ? void 0 : comment.assignment) === null || _f === void 0 ? void 0 : _f.playlistExternalUrl) || (((_g = comment.assignment) === null || _g === void 0 ? void 0 : _g.fileRequestPlaylistId) ? "".concat(appUrl, "/playlists/").concat((_h = comment.assignment) === null || _h === void 0 ? void 0 : _h.fileRequestPlaylistId, "?track=").concat((_j = comment === null || comment === void 0 ? void 0 : comment.submission) === null || _j === void 0 ? void 0 : _j.id) : "".concat(appUrl, "/assignments/").concat((_k = comment.assignment) === null || _k === void 0 ? void 0 : _k.id, "/playlist?track=").concat((_l = comment === null || comment === void 0 ? void 0 : comment.submission) === null || _l === void 0 ? void 0 : _l.id)) },
                                                react_1["default"].createElement(components_1.Text, null, (_m = comment === null || comment === void 0 ? void 0 : comment.submission) === null || _m === void 0 ? void 0 : _m.name))),
